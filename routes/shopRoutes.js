...
router.put(
  '/shop/:id',
  authorize(['farmer', 'admin', 'sub_admin']),  // Ensuring only authorized users can access
  upload.fields([  // Handle multiple files (shop images)
    { name: 'shop_image', maxCount: 5 },
    { name: 'shop_cover_image', maxCount: 1 },
    { name: 'shop_profile_image', maxCount: 1 },
  ]),
  updateShop  // Your controller function to update the shop
);
